          ...
          <Stack direction={"column"} spacing={2} sx={{marginTop: "10px"}}>
                      ...
                      onChange={(e) => {
                          setReq((o) => {
                              if (!isNaN(parseInt(e.target.value, 10))) {
                                  return {...o, ...{birth_year: parseInt(e.target.value, 10)}};
                              }
                              return o
                          });
                      }}
              ...
              <Stack direction={"column"} spacing={1}>
                  <Typography variant={"body2"}>
                      ...
                      {req.height && <RemoveCircleOutlineIcon onClick={() => setReq((o) => {
                          const tmp = o
                          if (tmp.height) {
                              delete tmp.height
                          }
                  ...
                  <Slider
                      ...
                      onChange={(_, newValue) => {
                          if (
                              ...
                              setReq((o) => ({...o, height: [newValue[0], newValue[1] == 5 ? 0 : newValue[1]]}));
                          }
                      }}
                  />
              </Stack>
              <Stack direction={"column"} spacing={1}>
                  <Typography variant={"body2"}>
                      ...
                      {req.b && <RemoveCircleOutlineIcon onClick={() => setReq((o) => {
                          const tmp = o
                          if (tmp.b) {
                              delete tmp.b
                          }
                  ...
                  <Slider
                      ...
                      onChange={(_, newValue) => {
                          if (
                              ...
                              setReq((o) => ({...o, b: [newValue[0], newValue[1] == 1 ? 0 : newValue[1]]}));
                          }
                      }}
                  />
              </Stack>
              <Stack direction={"column"} spacing={1}>
                  <Typography variant={"body2"}>
                      ...
                      {req.w && <RemoveCircleOutlineIcon onClick={() => setReq((o) => {
                          const tmp = o
                          if (tmp.w) {
                              delete tmp.w
                          }
                  ...
                  <Slider
                      ...
                      onChange={(_, newValue) => {
                          if (
                              ...
                              setReq((o) => ({...o, w: [newValue[0], newValue[1] == 1 ? 0 : newValue[1]]}));
                          }
                      }}
                  />
              </Stack>
              <Stack direction={"column"} spacing={1}>
                  <Typography variant={"body2"}>
                      ...
                      {req.h && <RemoveCircleOutlineIcon onClick={() => setReq((o) => {
                          const tmp = o
                          if (tmp.h) {
                              delete tmp.h
                          }
                  ...
                  <Slider
                      ...
                      onChange={(_, newValue) => {
                          if (
                              ...
                              setReq((o) => ({...o, h: [newValue[0], newValue[1] == 1 ? 0 : newValue[1]]}));
                          }
                      }}
                  />
              </Stack>
