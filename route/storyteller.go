...
func Storyteller(app *fiber.App) {
	...
	authenticated.Post("/projects/:project/stories/:story/agents/:agent/submit", storyteller.SubmitAgent)
	authenticated.Post("/projects/:project/stories/:story/agents/:agent/chats/:chat/resend", storyteller.ResubmitAgent)
	authenticated.Get("/projects/:project/stories/:story/agent-chats/:chat", storyteller.AgentChat)
	...
	authenticated.Post("/projects/:project/lores/:lore/agents/:agent/submit", storyteller.SubmitAgent)
	authenticated.Post("/projects/:project/lores/:lore/agents/:agent/chats/:chat/resend", storyteller.ResubmitAgent)
	authenticated.Get("/projects/:project/lores/:lore/agent-chats/:chat", storyteller.AgentChat)
