...
func Storyteller(app *fiber.App) {
	...
	authenticated.Post("/projects/:project/stories/:story/agent-chats", storyteller.SubmitAgent)
	authenticated.Post("/projects/:project/stories/:story/agent-chats/:chat/resend", storyteller.ResubmitAgent)
	...
	authenticated.Post("/projects/:project/lores/:lore/agent-chats", storyteller.SubmitAgent)
	authenticated.Post("/projects/:project/lores/:lore/agent-chats/:chat/resend", storyteller.ResubmitAgent)
