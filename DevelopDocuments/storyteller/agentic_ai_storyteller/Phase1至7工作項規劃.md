...
- **提案（Proposal）否決後的意見回饋機制**：2026-08-28 討論定案，明天（2026-08-29）要請 Claude 把需求整理丟給 Codex 施工，不是長期擱置項。設計細節見 [提案否決回饋機制_2026-08-28.md](提案否決回饋機制_2026-08-28.md)——結論是應該純前端就能做完（借用既有「回覆」功能的 `reply_content` 機制），不用動 backend。
