...
- **AI 助理輸入框高亮與版面問題**：2026-08-30 提出，4 個問題（@story/@lore 候選插入游標跑掉、slash command 沒有高亮、面板高度被輸入區擠壓）已查證根因並跟 Codex 討論過建議方向，見 [輸入框高亮與版面問題_2026-08-30.md](輸入框高亮與版面問題_2026-08-30.md)。面板高度那項需要使用者先回答文件裡的釐清問題才能定案。**不要主動實作**，等使用者明確下指示才整理丟給 Codex。
